...
const ReleaseCardInfo = ({
    ...
    // Animate the rating bar when component mounts
    useEffect(() => {
        const userRating = item?.averageRating || 0;
        const percentage = (userRating / 5) * 100;
    ...
    // Using the same user rating for the star display that was previously showing defRating
    const renderRating = () => {
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={[styles.container, hasShadow && shadowStyle]}>
                ...
                <View style={styles.overlay}>
                    {/* Rating Stars - Top Left - Now using averageRating */}
                    {renderRating()}
