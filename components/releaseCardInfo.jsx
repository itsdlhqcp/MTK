...
const ReleaseCardInfo = ({
    ...
    // Function to render user rating with visual meter
        ...
        <View style={styles.mainContainer}>
            ...
            {showPosterView && (
                <View style={styles.hiddenContainer}>
                    <PosterReview ref={posterRef} item={item} />
                </View>
            )}
                    ...
                    <View style={styles.bottomContent}>
                        ...
                        {showReviewButton && (
                            <View style={styles.actionButtons}>
                                ...
                                >
                                    <Icon name="plus" size={hp(2.5)} color={theme.colors.blue} />
                                </TouchableOpacity>
...
//             <View style={posterStyles.imageContainer}>
//                 {item?.filel && (
//                     <Image 
//                         source={getSupabaseFileUrl(item.filel)} 
...
//                     <Text style={posterStyles.titleText}>
//                         {stripHtmlTags(item?.body || "")}
//                     </Text>
//                     <Text style={posterStyles.infoText}>
//                         {extractYear} • {item?.duration || 'N/A'} • {item?.lang || 'N/A'}
//                     </Text>
//                     <View style={posterStyles.divider} />
                    
//                     {/* Our Rating */}
//                     <View style={posterStyles.ratingRow}>
//                         <Text style={posterStyles.ratingLabel}>our</Text>
//                         <View style={posterStyles.starsContainer}>
//                             {Array(5).fill(0).map((_, index) => (
//                                 <Text key={`our-${index}`} style={posterStyles.star}>
...
//                     {/* User Rating */}
//                     <View style={posterStyles.ratingRow}>
//                         <Text style={posterStyles.ratingLabel}>user Rating</Text>
//                         <View style={posterStyles.starsContainer}>
//                             {Array(5).fill(0).map((_, index) => (
//                                 <Text key={`user-${index}`} style={posterStyles.star}>
...
//                     <Text style={posterStyles.reviewCount}>
...
//                 <Text style={posterStyles.downloadText}>Download Now</Text>
//             </View>
//         </View>
//     );
// });
