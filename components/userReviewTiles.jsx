...
const MonthHeader = ({ month, viewMode, onToggleView }) => (
...
const UserReviewsComponent = ({ navigation }) => {
  ...
  const renderListItem = ({ item }) => {
    ...
    if (item.isHeader) {
      return <MonthHeader month={item.month} viewMode={viewMode} onToggleView={toggleViewMode} />;
    }
            ...
            >
              ...
              <View style={styles.movieInfoContainer}>
                ...
                <TouchableOpacity style={styles.menuButton}>
                  <Icon name="menu" size={hp(2)} color="#BDBDBD" />
                </TouchableOpacity>
              </View>
            </TouchableOpacity>
  ...
  const renderGridSection = ({ item }) => {
    return (
      <View style={styles.gridSection}>
        <MonthHeader month={item.month} viewMode={viewMode} onToggleView={toggleViewMode} />
        <FlatList
