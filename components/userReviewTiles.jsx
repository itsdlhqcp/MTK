...
const renderGridRow = ({ item }) => {
  ...
  // Add a function to render offline bar
  // const renderOfflineBar = () => {
  //   if (!isConnected) {
  //     return (
  //       <View style={[styles.offlineBar, { backgroundColor: theme.colors.rose }]}>
  ...
  return (
    <View style={styles.container}>
      {/* Render offline bar if disconnected */}
      {/* {renderOfflineBar()} */}
      ...
      {loading ? (
        ...
        viewMode === 'list' ? (
          ...
          <FlatList
            ...
            onRefresh={isConnected ? loadAllReviews : null} // Only allow refresh when connected
            refreshing={loading}
          />
        ) : (
