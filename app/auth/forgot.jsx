...
import React, { useState, useRef } from 'react';
import { View, StyleSheet, Text, TouchableOpacity, StatusBar as RNStatusBar, Modal, Animated, Pressable, ImageBackground } from 'react-native';
import { useAuth } from '../../contexts/AuthContext';
import ScreenWrapper from '@/components/ScreenWrapper';
import { StatusBar } from 'expo-status-bar';
import BackButton from '@/components/BackButton';
...
export default function ForgotPasswordScreen() {
  ...
  const colors = {
    ...
    gradientEnd: '#8B0000', // Dark red shade
    lightText: '#e0e0e0',
    magicLinkButton: 'rgba(150, 139, 139, 0.2)', // New magic link button color
  };
  ...
  return (
    ...
    <View style={styles.mainContainer}>
      ...
      {/* Background Image */}
      <ImageBackground
        source={require('../../assets/grid-images/intes.jpg')}
      ...
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <Text style={styles.instructionText}>
            We'll send you a secret link to sign in without a password
          </Text>
