import { View, StyleSheet, Text, ScrollView, TouchableOpacity, Alert, StatusBar as RNStatusBar, Animated, ImageBackground } from 'react-native';
...
const UserPreferences = () => {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      {/* Background Image */}
      <ImageBackground
        source={require('../../../assets/grid-images/rock.jpg')}
