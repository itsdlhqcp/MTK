...
const styles = StyleSheet.create({
    ...
    plotTwistContainer: {
        ...
        alignItems: 'center',
        zIndex: 100, // Ensure it's above the grid but below the toast
        pointerEvents: 'none', // This allows touch events to pass through to elements below
    },
    plotTwistText: {
        fontSize: 40,
        fontWeight: 'bold',
        ...
        textShadowRadius: 10,
        letterSpacing: 1.5,
        // Add a gradient-like effect with the red and blue colors
    ...
    image: {
        width: '100%',
        aspectRatio: 0.515, // Creates the tall poster-like appearance
        borderRadius: 0,
    },
    buttonContainer: {
        position: 'absolute',
