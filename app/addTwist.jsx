...
//     // Update the onSubmit function to handle YouTube link
...
//     // If editing a post with a YouTube link
//     if (post.youtubeLink && !youtubeLink) {
//       data.youtubeLink = null; // Remove the YouTube link if empty
//     }
//   }
...
// // Update useEffect to load YouTube link if editing a post
// useEffect(() => {
//   if (post && post.id) {
//     bodyRef.current = post.body; 
//     setFile(post.file || null);
