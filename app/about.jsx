      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.logoContainer}>
          <View style={styles.appLogoWrapper}>
            ...
            <Icon name="tv" size={48} color={instagramTheme.colors.primary} />
          </View>
          <Text style={styles.appTitle}>Plot Twist</Text>
        ...
        <View style={styles.socialContainer}>
          ...
          <View style={styles.socialButtonsContainer}>
            ...
            <SocialButton 
              ...
              onPress={() => openURL('https://doc-hosting.flycricket.io/plottwist-privacy-policy/f92ff1b6-e29c-4dab-b265-b1ce7f497179/privacy')} 
            />
          </View>
        </View>
