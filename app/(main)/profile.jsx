...
//   //     } else if (!profileDataTimestamp) {
//   //       // Only fetch profile stats on first load or when required
//   //       fetchProfileStats();
//   //     } else if (params.refreshProfile) {
//   //       // Only refresh if explicitly requested via params
//   //       fetchProfileStats();
//   //     }
//   //   }, [user, params.refreshProfile])
//   // );
...
//           fetchProfileStats();
//         }
//       }, [user, profileData, params.refreshProfile])
//     );
...
//   // Fetch profile statistics (post count, etc.)
//  // Update the fetchProfileStats function to also fetch friends count:
...
// //       }));
// //       setProfileDataTimestamp(Date.now());
// //     }
// //   } catch (error) {
...
// const InstagramProfile = React.memo(({ user, router, handleLogout, theme, postCount, friendsCount, isLoading }) => {
...
//         const cachedStats = await UserStorageService.getItem('profileStats');
//         if (cachedStats) {
//           const parsedStats = JSON.parse(cachedStats);
//           setCachedProfileStats(parsedStats);
//           setProfileStats(parsedStats.data);
//           setProfileDataTimestamp(parsedStats.timestamp);
//         }
//       } catch (error) {
//         console.error('Error loading profile data from storage:', error);
//       }
...
const Profile = () => {
  ...
  //       const currentUserData = await UserStorageService.getUserData() || {};
        
  //       // Update only the profileStats field using updateUserData
  //       await UserStorageService.updateUserData({
  //         profileStats: cacheData
  //       });
  //     }
  //   } catch (error) {
  //     console.error('Error fetching profile stats:', error);
