...
// // 2. Modify the handleNewComment function to properly update the comment count
// // const handleNewComment = async (payload) => {
// //     if (payload.new) {
// //       let newComment = {...payload.new}; 
// //       let res = await getUserData(newComment.userId);
...
// //       setPost(prevPost => {
// //         // Only add to comments array if it's a top-level comment (not a reply)
...
//         headerTitle: "Post Details",  // Kept this for reference
//         headerTitleStyle: styles.headerTitle,  // Kept this for reference
//         headerRight: () => (
//             <Pressable onPress={handleClose} style={styles.closeButton}>
