...
const StreamPeopleDetails = () => {
    ...
    useFocusEffect(
        ...
        // useEffect(() => {
        //     // This will handle when we return from the review screen
        //     const unsubscribe = router.addListener('focus', () => {
        //     // Check if we have review text from the review page
        //     const params = router.current?.params;
        //     if (params?.reviewText) {
        //         // Update reviewRef with the returned text
        //         reviewRef.current = params.reviewText;
    ...
    const ahandleNewReply = async (payload) => {
        ...
        const handleFinalReviewSubmit = async (rating, cupOfTea, prefer, predict, repeat, reviewTextFromSheet) => {
            ...
            console.log("Submitting review with text:", finalReviewText);
            let data = {
                userId: user.id,
...
//         const handleFinalReviewSubmit = async (rating, cupOfTea, prefer, predict, repeat) => {
//             let data = {
//                 userId: user.id,
//                 releaseId: release.id,
