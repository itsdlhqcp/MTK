...
//       <Text>GRid page</Text>
//      {/* PLACE THIS BUTTON ABOVE GRID BACKGROUND */}
//       <Button title='grid here' onPress={() => router.push('/onboardingGrid')} />
//     </ScreenWrapper>
//   )
// }

// export default index
// import { Text, Button, View, Image, StyleSheet, Dimensions, TouchableOpacity } from 'react-native'
// import React from 'react'
// import { useRouter } from 'expo-router'
// import ScreenWrapper from '@/components/ScreenWrapper';
...
//     },
//     gridItem: {
//         width: (Dimensions.get('window').width - 30) / 4, // 2 columns with spacing
