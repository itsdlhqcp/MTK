...
const Cup = (props) => (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="#ffffff" fill="none" {...props}>
        ...
        <Path d="M10 8.5V13.5M8.50424 16.2966L8.79616 14.4451C8.88166 13.9028 9.39425 13.5 9.99884 13.5C10.6034 13.5 11.116 13.9028 11.2015 14.4451L11.4934 16.2966C11.6508 17.2944 8.36613 17.1726 8.50424 16.2966Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
